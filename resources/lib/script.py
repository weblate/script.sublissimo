...
def synchronize_with_other_subtitle(subtitlefile, filename, fail=False):
    ...
    try:
        sync_subtitlefile, not_important = read_file(sync_filename, False)
    except:
        show_dialog(subtitlefile, filename)
...
def move_subtitle(subtitlefile, filename, menuchoice=""):
    ...
    if menuchoice == 0:
        ...
        if movement:
            ...
            new_subtitlefile = current_moving_sub.create_new_times(movement, None, None)
